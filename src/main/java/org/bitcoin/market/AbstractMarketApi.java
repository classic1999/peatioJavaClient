...
public abstract class AbstractMarketApi {
    ...
    public abstract List<Kline> getKline5Min(Symbol symbol) throws IOException, ParseException;

    public abstract List<Kline> getKline1Min(Symbol symbol) throws IOException, ParseException;
